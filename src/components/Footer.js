          ...
          <div className="column is-5 is-4-widescreen">
            <Link className="brand" to="/">
              <div className="brand-icon">
                <span className="is-size-4" style={{ color: "black", fontFamily: "pacifico" }}>learningSage</span>
              </div>
            </Link>
              ...
              <div className="column is-4">
                <div className="menu">
                  ...
                  <ul className="menu-list">
                    <li>
                      <a
                        href="https://www.facebook.com/learningsage/"
                        target="_blank"
                        rel="noopener noreferrer"
                      >
                        <img
                    ...
                    <li>
                      <a
                        href="https://www.instagram.com/learningsage/"
                        target="_blank"
                        rel="noopener noreferrer"
                      >
                        <img
                    ...
                    {/* <li>
                      ...
                      >
                        <img
                          src="https://uploads.divjoy.com/icon-linkedin.svg"
                          alt="Linkedin"
                        />
                        Linkedin
                      </a>
